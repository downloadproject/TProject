...
// configuration step. It creates a namespace called `TProject`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", TProject::cmake::project_name, TProject::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", TProject::cmake::project_version);
      return EXIT_SUCCESS;
    }
